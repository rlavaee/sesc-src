...
protected:
  ...
  virtual void doRead(MemRequest *mreq);           //NM made virtual
  virtual void doReadQueued(MemRequest *mreq);     //NM made virtual
  void doWriteBank(MemRequest *mreq);
  virtual void doWrite(MemRequest *mreq);
  void doWriteQueued(MemRequest *mreq);
  virtual void activateOverflow(MemRequest *mreq); //NM made virtual
 
  virtual void readMissHandler(MemRequest *mreq);  //NM made virtual
  ...
  void returnPush(MemRequest *mreq);
...
public:
  ...
  virtual bool isCache() const { return true; }
...
protected:
  ...
  //NM added
  void doPushBank(MemRequest *mreq);
  void doPush(MemRequest *mreq);

  typedef CallbackMember1<WBCache, MemRequest *, &WBCache::doPushBank>
    doPushBankCB;
  typedef CallbackMember1<WBCache, MemRequest *, &WBCache::doPush>
    doPushCB;
